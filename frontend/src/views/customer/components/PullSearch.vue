<template>
  <div class="pull-search-zone">
    <div v-if="open" class="pull-search-panel">
      <div class="search-input-wrap">
        <input ref="inputEl" v-model="draft" class="c-input" type="search" :placeholder="placeholder" @keyup.enter="submit" @search="handleNativeSearch">
        <button v-if="draft" class="search-clear" type="button" aria-label="清空检索" @click="clearInput">×</button>
      </div>
    </div>
    <button v-else type="button" class="pull-search-hint" :class="{ 'is-visible': pulling || modelValue }" @click="reveal">
